...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    ;;(define-advice org-agenda-list (around opened-org-agenda-list-around activate)
    ;;  (opened-org-agenda-files)
    ;;  ad-do-it
    ;;  (kill-org-agenda-files))
    ;;(define-advice org-search-view (around org-search-view-around activate)
    ;;  (opened-org-agenda-files)
    ;;  ad-do-it
    ;;  (kill-org-agenda-files))
    ;;(define-advice org-tags-view (around org-tags-view-around activate)
    ;;  (opened-org-agenda-files)
    ;;  ad-do-it
    ;;  (kill-org-agenda-files))
    ...
    ;;(define-advice org-agenda (around split-vertically activate)
